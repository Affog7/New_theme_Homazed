	...
	<div class="modal__overlay" tabindex="-1" data-micromodal-close>
		<div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="publish-home-title">
			...
			<main class="modal__content contact__form contact__form--light" id="publish-home-content">
				...
				//					   if($account_type && $account_type == "individual_user" ) {
...
<!-- Jobs -->
<div class="modal micromodal-slide modal--publish" id="publish-jobs" aria-hidden="true">
	<div class="modal__overlay" tabindex="-1" data-micromodal-close>
		<div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="publish-jobs-title">
			...
			<main class="modal__content contact__form contact__form--light" id="publish-jobs-content">
				<?php
				$account_type = get_field("user_account_type", "user_".get_current_user_id());
				/**
				 * todo_augustin type de compte

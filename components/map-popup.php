<div id="map-popup" class="default-bckg map-slate">
    <a href="#" class="map-slate--link flex">
        ...
        <div class="sidebar-icons">
            <div class="icon" data-open-modal="publish-home">
            <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10 5.86035V12.6104" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
<path d="M6.625 9.23535H13.375" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
<path fill-rule="evenodd" clip-rule="evenodd" d="M1.5625 3.79785C1.5625 2.141 2.90565 0.797852 4.5625 0.797852H15.4375C17.0944 0.797852 18.4375 2.141 18.4375 3.79785V14.6729C18.4375 16.3297 17.0944 17.6729 15.4375 17.6729H4.5625C2.90565 17.6729 1.5625 16.3297 1.5625 14.6729V3.79785Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
</svg>
            </div>

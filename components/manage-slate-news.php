...
<div class="card-form" style="border: 2px solid #7e7c804d">
    <div class="post-container">
        ...
        <!-- Premium Info -->
		<?php $post_link_parsed = get_field("post_link_parsed",$args['id']); ?>
        <div class="premium-info">
            <div class="premium-header">
				<?php
				if($post_link_parsed) {?>

				    <a href="<?php echo $post_link_parsed; ?>">
						<span class="premium-image" >
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="100px" width="150px" version="1.1" id="Layer_1" viewBox="0 0 512 512" xml:space="preserve">
								<g>

class ProjectsCategory {
    constructor(el) {
        ...
        this.optionsContainer = this.el.querySelector(".options-container-projects");
        this.tagsContainer = this.el.querySelector(".tags-container-projects");
        this.options = this.el.querySelectorAll(".options-container-projects div");
  
        this.hiddenTagsInput = document.querySelector(".projects-category-hidden-168 input");
    ...
    openDropdown() {
        this.optionsContainer.classList.remove("hidden-projects");
    }
  
    closeDropdown() {
        this.optionsContainer.classList.add("hidden-projects");
    }

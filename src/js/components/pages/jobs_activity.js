class JobActivity {
  constructor(el) {
      ...
      this.hiddenTagsInput = document.querySelector(".jobs-sector-activity-hidden-169 input");
  ...
  addTag(tagText) {
      ...
      if (!tagExists) {
          ...
          tag.className = "tag";
          tag.innerHTML = `${tagText} <span class="remove-tag" onclick="this.removeTag(this)">x</span>`;
  ...
  removeTag(removeButton) {
      ...
      this.updateHiddenTags(); // Mettre à jour les tags dans le champ caché après suppression
  }
